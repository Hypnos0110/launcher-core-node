import{W as k,a as E}from"./vendor.c0ba89a8.js";const x=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function d(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerpolicy&&(s.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?s.credentials="include":t.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(t){if(t.ep)return;t.ep=!0;const s=d(t);fetch(t.href,s)}};x();var m={translation:{repository:"Source Code Repository",launcher:{manage:{intro:"Manage your Minecraft effectively."},description:"All the things you might want to create a Minecraft Launcher"},author:"Contant Author",showCode:"Talk is cheap... Feel the code youself!",modelDisplay:"Model Display Samples",playerModel:"Player Model",blockModel:"Block Model"}},h={translation:{repository:"\u4ED3\u5E93\u5730\u5740",launcher:{manage:{intro:"Manage your Minecraft effectively."},description:"\u4E00\u4E2A\u7B80\u6D01\uFF0C\u5F00\u6E90\uFF0C\u529F\u80FD\u9A71\u52A8\u7684 Minecraft \u542F\u52A8\u6838\u5FC3"},author:"\u8054\u7CFB\u4F5C\u8005",showCode:"\u522B\u591A\u8BF4\u4E86\u2026\u2026\u611F\u53D7\u4E0B\u4F7F\u7528\u65F6 typescript \u7684 intellisense \u5427",modelDisplay:"\u6A21\u578B\u5C55\u793A",playerModel:"\u73A9\u5BB6\u6A21\u578B",blockModel:"\u65B9\u5757\u6A21\u578B"}};i18next.init({lng:navigator.language,resources:{en:m,zh:h,zh_CN:h,en_US:m}},function(r,n){jqueryI18next.init(i18next,$),$(".section").localize(),$(".bar").localize(),i18next.language==="zh-CN"||i18next==="zh"?$("#languages .text").text("\u7B80\u4F53\u4E2D\u6587"):$("#languages .text").text("English")});$(document).ready(function(){$("#languages").dropdown({onChange:function(r,n,d){i18next.changeLanguage(d.attr("value"),(o,t)=>{$(".section").localize(),$(".bar").localize()})}})});const R="modulepreload",g={},P="",v=function(n,d){return!d||d.length===0?n():Promise.all(d.map(o=>{if(o=`${P}${o}`,o in g)return;g[o]=!0;const t=o.endsWith(".css"),s=t?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${s}`))return;const a=document.createElement("link");if(a.rel=t?"stylesheet":R,t||(a.as="script",a.crossOrigin=""),a.href=o,document.head.appendChild(a),t)return new Promise((f,p)=>{a.addEventListener("load",f),a.addEventListener("error",p)})})).then(()=>n())};let b,L=w();async function w(){b=await(await fetch("https://api.github.com/repos/voxelum/minecraft-launcher-core-node/tags")).json()}async function I(){return await L,b[0].name}let y=v(()=>import("./demo.1426e397.js"),[]).then(({setupAll:r})=>r());$(document).ready(function(){$("body").pagepiling({onLeave:function(r,n,d){n===3?y.then(({play:o,stop:t})=>{o()}):r===3&&y.then(({play:o,stop:t})=>{t()})}})});$(".dropdown").dropdown();I().then(r=>{$("#version").text(r)});const e={};e["@xmcl/client/channel.d.ts"]=`/// <reference types="node" /> import ByteBuffer from "bytebuffer";
...
export {};
//# sourceMappingURL=channel.d.ts.map`;e["@xmcl/client/coders.d.ts"]=`/// <reference types="long" /> import ByteBuffer from "bytebuffer";
...
//# sourceMappingURL=coders.d.ts.map`;e["@xmcl/client/index.d.ts"]=`/**  * The client for Minecraft protocol. I can create the connection with Minecraft server and ping the server status.
 *
...
export * from "./status";
export * from "./lan";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/client/lan.d.ts"]=`/// <reference types="node" /> import { RemoteInfo } from "dgram";
import { EventEmitter } from "events";
...
//# sourceMappingURL=lan.d.ts.map`;e["@xmcl/client/packet.d.ts"]=`import { State } from "./channel"; import { Coder } from "./coders";
...
//# sourceMappingURL=packet.d.ts.map`;e["@xmcl/client/status.d.ts"]=`import { TextComponent } from "@xmcl/text-component"; import Long from "long";
...
export {};
//# sourceMappingURL=status.d.ts.map`;e["@xmcl/core/diagnose.d.ts"]=`import { ResolvedLibrary, ResolvedVersion } from "./version"; import { MinecraftFolder, MinecraftLocation } from "./folder";
/**
...
//# sourceMappingURL=diagnose.d.ts.map`;e["@xmcl/core/folder.d.ts"]=`export interface MinecraftFolder {     readonly root: string;
}
/**
...
//# sourceMappingURL=folder.d.ts.map`;e["@xmcl/core/index.d.ts"]=`/**  * The core package for launching Minecraft.
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/core/launch.d.ts"]=`/// <reference types="node" /> import { ChildProcess, SpawnOptions } from "child_process";
import { EventEmitter } from "events";
...
//# sourceMappingURL=launch.d.ts.map`;e["@xmcl/core/platform.d.ts"]=`/**  * The platform information related to current operating system.
 */
...
//# sourceMappingURL=platform.d.ts.map`;e["@xmcl/core/utils.d.ts"]=`/**  * @ignore
 */
...
//# sourceMappingURL=utils.d.ts.map`;e["@xmcl/core/version.d.ts"]=`import { MinecraftLocation } from "./folder"; import { Platform } from "./platform";
...
export {};
//# sourceMappingURL=version.d.ts.map`;e["@xmcl/curseforge/http/base.d.ts"]=`/// <reference types="node" /> import { Agent } from "https";
/**
...
//# sourceMappingURL=base.d.ts.map`;e["@xmcl/curseforge/http/index.browser.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/curseforge/http/index.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/curseforge/index.d.ts"]=`/// <reference types="node" /> import { Agent } from "https";
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/forge-site-parser/index.d.ts"]=`/**  * One forge version download info
 */
interface Download {
    md5: string;
    sha1: string;
...
export {};
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/gamesetting/index.d.ts"]=`/**  * Provide function to {@link parse} the options.txt and also {@link stringify} it into the string.
 *
 * @packageDocumentation
...
export {};
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/installer/curseforge.d.ts"]=`/// <reference types="node" /> import { MinecraftFolder, MinecraftLocation } from "@xmcl/core";
...
export {};
//# sourceMappingURL=curseforge.d.ts.map`;e["@xmcl/installer/diagnose.d.ts"]=`import { Issue, LibraryIssue, MinecraftFolder, MinecraftLocation } from "@xmcl/core"; import { InstallProfile, PostProcessor } from "./profile";
...
//# sourceMappingURL=diagnose.d.ts.map`;e["@xmcl/installer/downloadTask.d.ts"]=`import { AbortableTask } from "@xmcl/task"; import { Download, DownloadOptions } from "./http/download";
...
//# sourceMappingURL=downloadTask.d.ts.map`;e["@xmcl/installer/fabric.d.ts"]=`import { MinecraftLocation } from "@xmcl/core"; import { Timestamped } from "./http/fetch";
...
//# sourceMappingURL=fabric.d.ts.map`;e["@xmcl/installer/forge.d.ts"]=`import { MinecraftFolder, MinecraftLocation } from "@xmcl/core"; import { Task } from "@xmcl/task";
import { Entry, ZipFile } from "yauzl";
...
export {};
//# sourceMappingURL=forge.d.ts.map`;e["@xmcl/installer/http/abort.d.ts"]=`export interface AbortSignal {     readonly aborted: boolean;
...
//# sourceMappingURL=abort.d.ts.map`;e["@xmcl/installer/http/agents.d.ts"]=`/// <reference types="node" /> import { Agent as HttpAgent } from "http";
import { Agent as HttpsAgent } from "https";
/**
...
//# sourceMappingURL=agents.d.ts.map`;e["@xmcl/installer/http/download.d.ts"]=`/// <reference types="node" /> import { URL } from "url";
...
//# sourceMappingURL=download.d.ts.map`;e["@xmcl/installer/http/error.d.ts"]=`import { ResourceMetadata } from "./metadata"; import { Segment } from "./segment";
...
//# sourceMappingURL=error.d.ts.map`;e["@xmcl/installer/http/fetch.d.ts"]=`import { Agents } from "./agents"; export interface Timestamped {
    timestamp: string;
}
...
//# sourceMappingURL=fetch.d.ts.map`;e["@xmcl/installer/http/metadata.d.ts"]=`/// <reference types="node" /> import { Agents } from "./agents";
import { AbortSignal } from "./abort";
import { URL } from "url";
...
//# sourceMappingURL=metadata.d.ts.map`;e["@xmcl/installer/http/retry.d.ts"]=`import { DownloadError } from "./error"; import { ValidationError } from "./validator";
/**
...
//# sourceMappingURL=retry.d.ts.map`;e["@xmcl/installer/http/segment.d.ts"]=`export interface Segment {     start: number;
    end: number;
}
...
//# sourceMappingURL=segment.d.ts.map`;e["@xmcl/installer/http/status.d.ts"]=`/**  * The controller that maintain the download status
 */
...
//# sourceMappingURL=status.d.ts.map`;e["@xmcl/installer/http/utils.d.ts"]=`/// <reference types="node" /> import { Agent as HttpAgent, ClientRequest, IncomingMessage, RequestOptions } from "http";
import { AbortSignal } from "./abort";
import { Agent as HttpsAgent } from "https";
import { URL } from "url";
...
//# sourceMappingURL=utils.d.ts.map`;e["@xmcl/installer/http/validator.d.ts"]=`export interface Validator {     /**
...
//# sourceMappingURL=validator.d.ts.map`;e["@xmcl/installer/index.d.ts"]=`/**  * The installer module provides commonly used installation functions for Minecraft.
 * @packageDocumentation
...
export * from "./unzip";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/installer/java-runtime.d.ts"]=`import { Platform } from "@xmcl/core"; import { Task } from "@xmcl/task";
import { DownloadBaseOptions } from "./http/download";
import { ParallelTaskOptions } from "./utils";
/**
...
//# sourceMappingURL=java-runtime.d.ts.map`;e["@xmcl/installer/java.d.ts"]=`import { Platform } from "@xmcl/core"; import { Task } from "@xmcl/task";
import { DownloadTask } from "./downloadTask";
import { DownloadBaseOptions } from "./http/download";
...
export {};
//# sourceMappingURL=java.d.ts.map`;e["@xmcl/installer/liteloader.d.ts"]=`import { MinecraftLocation } from "@xmcl/core"; import { Task } from "@xmcl/task";
import { Timestamped } from "./http/fetch";
import { InstallOptions } from "./utils";
...
//# sourceMappingURL=liteloader.d.ts.map`;e["@xmcl/installer/minecraft.d.ts"]=`import { MinecraftFolder, MinecraftLocation, ResolvedLibrary, ResolvedVersion, Version } from "@xmcl/core"; import { Task } from "@xmcl/task";
import { DownloadTask } from "./downloadTask";
import { DownloadBaseOptions } from "./http/download";
import { Timestamped } from "./http/fetch";
import { ParallelTaskOptions } from "./utils";
...
//# sourceMappingURL=minecraft.d.ts.map`;e["@xmcl/installer/optifine.d.ts"]=`import { MinecraftLocation, Version } from "@xmcl/core"; import { InstallOptions, SpawnJavaOptions } from "./utils";
...
//# sourceMappingURL=optifine.d.ts.map`;e["@xmcl/installer/profile.d.ts"]=`import { MinecraftFolder, MinecraftLocation, Version as VersionJson } from "@xmcl/core"; import { AbortableTask } from "@xmcl/task";
...
//# sourceMappingURL=profile.d.ts.map`;e["@xmcl/installer/quilt.d.ts"]=`import { MinecraftLocation } from "@xmcl/core"; export declare const DEFAULT_META_URL = "https://meta.quiltmc.org";
...
//# sourceMappingURL=quilt.d.ts.map`;e["@xmcl/installer/unzip.d.ts"]=`import { BaseTask } from "@xmcl/task"; import { Entry, ZipFile } from "yauzl";
...
//# sourceMappingURL=unzip.d.ts.map`;e["@xmcl/installer/utils.d.ts"]=`/// <reference types="node" /> import { _exists as exists, _mkdir as mkdir, _pipeline as pipeline, _readFile as readFile, _writeFile as writeFile } from "@xmcl/core";
...
//# sourceMappingURL=utils.d.ts.map`;e["@xmcl/mod-parser/fabric.d.ts"]=`import { FileSystem } from "@xmcl/system"; declare type Person = {
    /**
...
export interface FabricModMetadata {
    ...
    /**
     * Defines the mod's icon. Icons are square PNG files. (Minecraft resource packs use 128\xD7128, but that is not a hard requirement - a power of two is, however, recommended.) Can be provided in one of two forms:
...
export {};
//# sourceMappingURL=fabric.d.ts.map`;e["@xmcl/mod-parser/forge.d.ts"]=`import { FileSystem } from "@xmcl/system"; /**
...
export {};
//# sourceMappingURL=forge.d.ts.map`;e["@xmcl/mod-parser/forgeConfig.d.ts"]=`/**  * Represent the forge config file
 */
...
//# sourceMappingURL=forgeConfig.d.ts.map`;e["@xmcl/mod-parser/index.d.ts"]=`/**  * @module @xmcl/mod-parser
 */
export * from "./forge";
...
export * from "./fabric";
export * from "./quilt";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/mod-parser/liteloader.d.ts"]=`import { FileSystem } from "@xmcl/system"; export interface LiteloaderModMetadata {
...
//# sourceMappingURL=liteloader.d.ts.map`;e["@xmcl/mod-parser/quilt.d.ts"]=`import { FileSystem } from "@xmcl/system"; export interface QuiltModMetadata {
    /**
     * \`1\` for now
     */
...
//# sourceMappingURL=quilt.d.ts.map`;e["@xmcl/model/block.d.ts"]=`import { BlockModel, PackMeta } from "@xmcl/resourcepack"; import { Object3D } from "three/src/core/Object3D";
...
export {};
//# sourceMappingURL=block.d.ts.map`;e["@xmcl/model/index.d.ts"]=`/**  * @module @xmcl/model
 */
export * from "./block";
export * from "./player";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/model/player-model.d.ts"]=`export interface ModelTemplate {     head: Part;
    rightLeg: Part;
    leftLeg: Part;
    torso: Part;
    leftArm: Part;
...
//# sourceMappingURL=player-model.d.ts.map`;e["@xmcl/model/player.d.ts"]=`import { Object3D } from "three/src/core/Object3D"; import { MeshBasicMaterial } from "three/src/materials/MeshBasicMaterial";
...
//# sourceMappingURL=player.d.ts.map`;e["@xmcl/modrinth/http/base.d.ts"]=`/// <reference types="node" /> import { Agent } from "https";
/**
 * Abstract layer for http requester.
 */
export declare type HttpRequester = (option: {
...
//# sourceMappingURL=base.d.ts.map`;e["@xmcl/modrinth/http/index.browser.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/modrinth/http/index.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/modrinth/index.d.ts"]=`/// <reference types="node" /> import { Project, ProjectVersion, User } from "./types";
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/modrinth/types.d.ts"]=`export interface User {     /**
     * The user's id
     */
    id: string;
    /**
...
//# sourceMappingURL=types.d.ts.map`;e["@xmcl/nbt/index.d.ts"]=`/**  * The nbt module provides nbt {@link serialize} and {@link deserialize} functions.
 *
 * @packageDocumentation
 * @module @xmcl/nbt
 */
...
export {};
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/nbt/utils.d.ts"]=`/// <reference types="bytebuffer" /> export declare function writeUTF8(out: ByteBuffer, str: string): number;
export declare function readUTF8(buff: ByteBuffer): string;
//# sourceMappingURL=utils.d.ts.map`;e["@xmcl/nbt/zlib/index.browser.d.ts"]=`export declare function gzip(buffer: Uint8Array): Promise<Uint8Array>; export declare function gzipSync(buffer: Uint8Array): Uint8Array;
...
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/nbt/zlib/index.d.ts"]=`import { deflateSync, gunzipSync, gzipSync, inflateSync } from "zlib"; export declare const gzip: (buf: Uint8Array) => Promise<Uint8Array>;
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/resourcepack/format.d.ts"]=`/**  * The pack meta json format
 */
...
export {};
//# sourceMappingURL=format.d.ts.map`;e["@xmcl/resourcepack/index.d.ts"]=`/**  * The resource pack module to read Minecraft resource pack just like Minecraft in-game.
 *
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/resourcepack/modelLoader.d.ts"]=`import { Resource } from "./resourcePack"; import { ResourceLoader } from "./resourceManager";
...
//# sourceMappingURL=modelLoader.d.ts.map`;e["@xmcl/resourcepack/resourceManager.d.ts"]=`import { PackMeta } from "./format"; import { ResourcePack, Resource, ResourceLocation } from "./resourcePack";
...
//# sourceMappingURL=resourceManager.d.ts.map`;e["@xmcl/resourcepack/resourcePack.d.ts"]=`/**  * The resource pack module to read Minecraft resource pack just like Minecraft in-game.
 *
 * You can open the ResourcePack by {@link ResourcePack.open} and get resource by {@link ResourcePack.get}.
 *
 * Or you can just load resource pack metadata by {@link readPackMetaAndIcon}.
...
//# sourceMappingURL=resourcePack.d.ts.map`;e["@xmcl/server-info/index.d.ts"]=`export declare class ServerInfo {     icon: string;
    ip: string;
    name: string;
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/system/index.browser.d.ts"]=`import { FileSystem } from "./system"; export declare function openFileSystem(basePath: string | Uint8Array): Promise<FileSystem>;
export declare function resolveFileSystem(base: string | Uint8Array | FileSystem): Promise<FileSystem>;
export * from "./system";
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/system/index.d.ts"]=`import { FileSystem } from "./system"; export declare function openFileSystem(basePath: string | Uint8Array): Promise<FileSystem>;
export declare function resolveFileSystem(base: string | Uint8Array | FileSystem): Promise<FileSystem>;
export * from "./system";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/system/system.d.ts"]=`export declare abstract class FileSystem {     abstract readonly root: string;
...
//# sourceMappingURL=system.d.ts.map`;e["@xmcl/task/index.d.ts"]=`/**  * @module @xmcl/task
 */
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/text-component/index.d.ts"]=`/**  * @module @xmcl/text-component
 */
/**
...
/**
 * Convert a text component to Minecraft specific formatted string like \`\xA71colored\xA7r\`
 */
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/unzip/index.d.ts"]=`/// <reference types="node" /> /**
 * @module @xmcl/unzip
 */
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/user/auth.d.ts"]=`import { GameProfile } from "./base"; declare type LoginWithUser = {
    username: string;
    password: string;
    requestUser: true;
} | {
...
export {};
//# sourceMappingURL=auth.d.ts.map`;e["@xmcl/user/base.d.ts"]=`/**  * The game profile of the user.
 *
...
//# sourceMappingURL=base.d.ts.map`;e["@xmcl/user/index.d.ts"]=`/**  * @module @xmcl/user
 */
export * from "./auth";
export { GameProfile, GameProfileWithProperties } from "./base";
export * from "./mojang";
export * from "./service";
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/user/mojang.d.ts"]=`/**  * Users defined question when they register this account
 *
...
//# sourceMappingURL=mojang.d.ts.map`;e["@xmcl/user/service.d.ts"]=`import { GameProfile, GameProfileWithProperties } from "./base"; export interface ProfileLookupException {
    /**
...
//# sourceMappingURL=service.d.ts.map`;e["@xmcl/user/util/base.d.ts"]=`/**  * Abstract layer for http requester.
 */
export declare type HttpRequester = (option: {
    url: string;
    method: string;
...
//# sourceMappingURL=base.d.ts.map`;e["@xmcl/user/util/index.browser.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
...
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/user/util/index.d.ts"]=`import { HttpRequester } from "./base"; export declare const httpRequester: HttpRequester;
export declare function verify(data: string, signature: string, pemKey: string | Uint8Array): Promise<boolean>;
export declare function decodeBase64(s: string): string;
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/user/v5/esm.browser.d.ts"]=`export { default as sha1 } from "uuid/dist/esm-browser/sha1"; export { default as v35 } from "uuid/dist/esm-browser/v35";
//# sourceMappingURL=esm.browser.d.ts.map`;e["@xmcl/user/v5/esm.d.ts"]=`export { default as sha1 } from "uuid/dist/esm-node/sha1"; export { default as v35 } from "uuid/dist/esm-node/v35";
//# sourceMappingURL=esm.d.ts.map`;e["@xmcl/user/v5/index.browser.d.ts"]=`export { default as sha1 } from "uuid/dist/sha1-browser"; export { default as v35 } from "uuid/dist/esm-browser/v35";
//# sourceMappingURL=index.browser.d.ts.map`;e["@xmcl/user/v5/index.d.ts"]=`import sha1 from "uuid/dist/sha1"; import v35 from "uuid/dist/v35";
export { v35, sha1 };
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/world/index.d.ts"]=`import { FileSystem } from "@xmcl/system"; import Long from "long";
...
export {};
//# sourceMappingURL=index.d.ts.map`;e["assert.d.ts"]=`declare module 'assert' {     /** An alias of \`assert.ok()\`. */
...
`;e["async_hooks.d.ts"]=`/**  * Async Hooks module: https://nodejs.org/api/async_hooks.html
 */
...
`;e["buffer.d.ts"]=`declare module 'buffer' {     export const INSPECT_MAX_BYTES: number;
...
`;e["child_process.d.ts"]=`declare module 'child_process' {     import { BaseEncodingOptions } from 'fs';
...
`;e["cluster.d.ts"]=`declare module 'cluster' {     import * as child from 'child_process';
...
`;e["console.d.ts"]=`declare module 'console' {     import { InspectOptions } from 'util';
...
`;e["constants.d.ts"]=`/** @deprecated since v6.3.0 - use constants property exposed by the relevant module instead. */ declare module 'constants' {
...
`;e["crypto.d.ts"]=`declare module 'crypto' {     import * as stream from 'stream';
...
`;e["dgram.d.ts"]=`declare module 'dgram' {     import { AddressInfo } from 'net';
...
`;e["dns.d.ts"]=`declare module 'dns' {     // Supported getaddrinfo flags.
...
`;e["domain.d.ts"]=`declare module 'domain' {     import EventEmitter = require('events');
...
`;e["events.d.ts"]=`declare module 'events' {     interface EventEmitterOptions {
        /**
...
`;e["fs.d.ts"]=`declare module 'fs' {     import * as stream from 'stream';
    import EventEmitter = require('events');
    import { URL } from 'url';
...
`;e["globals.d.ts"]=`// Declare "static" methods in Error interface ErrorConstructor {
...
`;e["globals.global.d.ts"]="declare var global: NodeJS.Global & typeof globalThis; ";e["http.d.ts"]=`declare module 'http' {     import * as stream from 'stream';
    import { URL } from 'url';
...
`;e["http2.d.ts"]=`declare module 'http2' {     import EventEmitter = require('events');
...
`;e["https.d.ts"]=`declare module 'https' {     import { Duplex } from 'stream';
    import * as tls from 'tls';
...
`;e["index.d.ts"]=`// Type definitions for non-npm package Node.js 14.17 // Project: https://nodejs.org/
...
`;e["inspector.d.ts"]=`// tslint:disable-next-line:dt-header // Type definitions for inspector
...
`;e["module.d.ts"]=`declare module 'module' {     import { URL } from 'url';
    namespace Module {
        /**
...
`;e["net.d.ts"]=`declare module 'net' {     import * as stream from 'stream';
    import EventEmitter = require('events');
    import * as dns from 'dns';
...
`;e["os.d.ts"]=`declare module 'os' {     interface CpuInfo {
        model: string;
        speed: number;
        times: {
            user: number;
...
`;e["path.d.ts"]=`declare module 'path' {     namespace path {
        /**
        ...
        interface ParsedPath {
            ...
            root: string;
            /**
             * The full directory path such as '/home/user/dir' or 'c:pathdir'
             */
            dir: string;
            /**
...
`;e["perf_hooks.d.ts"]=`declare module 'perf_hooks' {     import { AsyncResource } from 'async_hooks';
...
`;e["process.d.ts"]=`declare module 'process' {     import * as tty from 'tty';
...
`;e["punycode.d.ts"]=`/**  * @deprecated since v7.0.0
...
`;e["querystring.d.ts"]=`declare module 'querystring' {     interface StringifyOptions {
...
`;e["readline.d.ts"]=`declare module 'readline' {     import EventEmitter = require('events');
...
`;e["repl.d.ts"]=`declare module 'repl' {     import { Interface, Completer, AsyncCompleter } from 'readline';
...
`;e["stream.d.ts"]=`declare module 'stream' {     import EventEmitter = require('events');
...
`;e["string_decoder.d.ts"]=`declare module 'string_decoder' {     class StringDecoder {
        constructor(encoding?: BufferEncoding);
        write(buffer: Buffer): string;
        end(buffer?: Buffer): string;
    }
}
`;e["timers.d.ts"]=`declare module 'timers' {     function setTimeout(callback: (...args: any[]) => void, ms?: number, ...args: any[]): NodeJS.Timeout;
...
`;e["tls.d.ts"]=`declare module 'tls' {     import * as net from 'net';
...
`;e["trace_events.d.ts"]=`declare module 'trace_events' {     /**
...
`;e["tty.d.ts"]=`declare module 'tty' {     import * as net from 'net';
...
`;e["url.d.ts"]=`declare module 'url' {     import { ParsedUrlQuery, ParsedUrlQueryInput } from 'querystring';
...
`;e["util.d.ts"]=`declare module 'util' {     interface InspectOptions extends NodeJS.InspectOptions { }
...
`;e["v8.d.ts"]=`declare module 'v8' {     import { Readable } from 'stream';
...
`;e["vm.d.ts"]=`declare module 'vm' {     interface Context extends NodeJS.Dict<any> { }
...
`;e["wasi.d.ts"]=`declare module 'wasi' {     interface WASIOptions {
        /**
...
`;e["worker_threads.d.ts"]=`declare module 'worker_threads' {     import { Context } from 'vm';
    import EventEmitter = require('events');
...
`;e["zlib.d.ts"]=`declare module 'zlib' {     import * as stream from 'stream';
...
`;const c={};c.common=`import { launch } from '@xmcl/core'; import { login, Authentication, offline } from '@xmcl/user';
...
`;c.installer=`import { install, MinecraftVersionList, getVersionList, MinecraftVersion, installTask } from '@xmcl/installer'; 
...
`;c.skin=`/// suppose you are on electron MAIN process /// 
...
`;self.MonacoEnvironment={getWorker(r,n){return n==="typescript"||n==="javascript"?new k({name:n}):new E({name:n})}};v(()=>import("./editor.main.dd809486.js").then(function(r){return r.b}),["assets/editor.main.dd809486.js","assets/editor.main.97fc4d73.css"]).then(({languages:r,editor:n,KeyCode:d,Uri:o})=>{r.typescript.typescriptDefaults.setCompilerOptions({target:r.typescript.ScriptTarget.ESNext,allowNonTsExtensions:!0,moduleResolution:r.typescript.ModuleResolutionKind.NodeJs,module:r.typescript.ModuleKind.ESNext,allowSyntheticDefaultImports:!0});const t={};for(const i of Object.keys(e)){const l=`file:///node_modules/${i}`;r.typescript.typescriptDefaults.addExtraLib(e[i],l),t[i]=n.createModel(e[i],"typescript",o.parse(l))}const s={};for(const i of Object.keys(c))s[i]=n.createModel(c[i],"typescript",o.parse(`${i}.ts`));const a=n.create(document.getElementById("editor"),{model:s.common,language:"typescript",theme:"vs-dark",automaticLayout:!0}),f=[];a.onDidChangeModel(i=>{f.push(i.newModelUrl)});const p=a._codeEditorService,T=p.openCodeEditor.bind(p);p.openCodeEditor=async(i,l)=>{const u=await T(i,l);if(!u){const S=n.getModel(i.resource);l.setModel(S),l.setSelection(i.options.selection),l.revealLines(i.options.selection.startLineNumber,i.options.selection.endLineNumber,i.options.selectionRevealType)}return u},$("#code-sample").dropdown({onChange:function(i,l,u){a.setModel(s[u.attr("value")])}})});
